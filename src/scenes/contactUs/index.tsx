            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                ...
                >
                    <form 
                        ...
                        onSubmit={onSubmit}
                        method='POST'
                        action="https://formsubmit.co/9e7f0a2812e5b6f0b539a69111ba0021"
                    >
                        <input
                        ...
                        {errors.email && (
                            <p className="mt-1 text-primary-500">
                                ...
                                {errors.email.type === "pattern" && "I nvalid emial address."}
                            </p>
                        )}
                        ...
                        {errors.message && (
                            <p className="mt-1 text-primary-500">
                                ...
                                {errors.message.type === "maxLength" && "Max Length is 20 00 Char."}
                            </p>
                        )}
                        <button
                            type="submit"
